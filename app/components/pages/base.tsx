  ...
  return (
    <>
      <header className="flex flex-row gap-5 p-5 justify-center items-center">
        <h1 className="text-2xl">Tik Tak Toe</h1>
          ...
          <ul className="flex flex-row gap-1">
            {TOP_LINKS.map((link) => {
              return (
                <li
                  key={link.href}
                  className="underline border p-2 rounded-md hover:bg-white hover:text-black transition duration-300"
                >
      ...
      <footer className="p-5">© Copyright 2026 Andres Carrera</footer>
    </>
  );
}
